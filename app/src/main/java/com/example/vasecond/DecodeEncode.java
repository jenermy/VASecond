...
public class DecodeEncode {
    private static final String TAG = "wanlijun";
    ByteBuffer[] decodeInputBuffers = null;
    ByteBuffer[] decodeOutputBuffers = null;
    MediaCodec.BufferInfo decodeBufferInfo = null;
    ByteBuffer[] encodeInputBuffers = null;
    ByteBuffer[] encodeOutputBuffers = null;
    MediaCodec.BufferInfo encodeBufferInfo = null;
...
//                    format.setInteger(MediaFormat.KEY_MAX_INPUT_SIZE, 200 * 1024);
    ...
    private void initAACMediaEncode() {
        ...
        try {
            ...
            encodeFormat.setInteger(MediaFormat.KEY_MAX_INPUT_SIZE, 500 * 1024);//作用于inputBuffer的大小
            mediaEncode = MediaCodec.createEncoderByType("audio/mp4a-latm");
...
//        showLog("doEncode");
        Log.i("wanlijun","dstAudioFormatFromPCM:"+encodeInputBuffers.length);
...
// fill in ADTS data
        ...
        private String srcPath = Environment.getExternalStorageDirectory()+"/Video/autumn.mp4";
        ...
        public static DecodeEncode newInstance() {
            return new DecodeEncode();
        }
...
//            }
            ...
            try {
                fos = new FileOutputStream(new File(Environment.getExternalStorageDirectory()+"/va/newFormat"));
...
//            }
        ...
        private void putPCMData(byte[] pcmChunk) {
            synchronized (DecodeEncode.class) {//记得加锁
